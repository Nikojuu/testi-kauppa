...
import korvakorut from "../../public/korvakorut.jpg";
import kaulakorut from "../../public/kaulakorut.jpg";
    ...
    <div className="py-24 sm:py-32">
      ...
      <div className="mt-6 grid grid-cols-1 gap-y-6 sm:grid-cols-2 sm:grid-rows-2 sm:gap-x-6 lg:gap-8">
        ...
        <div className="group aspect-w-2 aspect-h-1 rounded-lg overflow-hidden sm:relative sm:aspect-none sm:h-full">
          <Image
            src={korvakorut}
            alt="Products for korvakorut Image"
          ...
          <div className="p-6 flex items-end sm:absolute sm:inset-0">
            <Link href="/products/korvakorut">
              <h3 className="text-white font-semibold">Korvakorut</h3>
              <p className="mt-1 text-sm text-white">Shop Now</p>
            </Link>
          </div>
        </div>
        ...
        <div className="group aspect-w-2 aspect-h-1 rounded-lg overflow-hidden sm:relative sm:aspect-none sm:h-full">
          ...
          <div className="bg-gradient-to-b from-transparent to-black opacity-55 sm:absolute sm:inset-0" />
          <div className="p-6 flex items-end sm:absolute sm:inset-0">
            <Link href="/products/kaulakorut">
              <h3 className="text-white font-semibold">Kaulakorut</h3>
              <p className="mt-1 text-sm text-white">Shop Now</p>
            </Link>
          </div>
        </div>
