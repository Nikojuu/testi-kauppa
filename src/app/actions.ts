...
// type CheckOutData = {
//   items: CartItem[];
//   shipmentMethod: ShipmentMethods; // Ensure this is a number
// };

// export const checkOut = async (data: CheckOutData) => {
//   const { items: cart, shipmentMethod } = data;
...
//   const updatedLineItems: Stripe.Checkout.SessionCreateParams.LineItem[] =
//     await Promise.all(
//       cart.map(async (item: CartItem) => {
//         const product = await prisma.product.findUnique({
//           where: { id: item.product.id, storeId: store.id },
//         });
//         if (!product)
...
//           price_data: {
//             currency: "eur",
//             unit_amount: product.price * 100, // Use updated price
//             product_data: {
//               name: product.name, // Use updated name
//               images: [product.images[0]], // Use updated image
//             },
//           },
//           quantity: 1, // i need to make quantity in database later
//         };
//       })
//     );
...
//             type: "fixed_amount",
//             fixed_amount: {
//               amount: shipmentMethod.cost * 100,
//               currency: "eur",
//             },
//             display_name: shipmentMethod.name,
//             ...(shipmentMethod.min_estimate_delivery_days ||
//             shipmentMethod.max_estimate_delivery_days
//               ? {
//                   delivery_estimate: {
//                     minimum: {
//                       unit: "business_day",
//                       value: shipmentMethod.min_estimate_delivery_days || 0,
//                     },
//                     maximum: {
//                       unit: "business_day",
//                       value: shipmentMethod.max_estimate_delivery_days || 0,
//                     },
//                   },
//                 }
//               : {}),
...
//       payment_intent_data: {
//         transfer_data: {
//           destination: store.connectedAccountId,
//         },
//       },
//       metadata: {
//         storeId: store.id,
//         shipmentMethodsId: shipmentMethod.id,
//       },
//     });
